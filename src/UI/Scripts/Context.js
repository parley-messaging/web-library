...
export const InterfaceTexts = {
	english: {
		...
		ariaLabelButtonDownloadMedia: "download",
		ariaLabelButtonCall: "call",
		ariaLabelButtonWebUrl: "open webpage",
		ariaLabelButtonPredefinedReply: message => `Send message: ${message}`,
		ariaLabelButtonCloseImageViewer: "close image view",
	...
	dutch: {
		...
		ariaLabelButtonDownloadMedia: "download",
		ariaLabelButtonCall: "bel",
		ariaLabelButtonWebUrl: "open webpagina",
		ariaLabelButtonPredefinedReply: message => `Verstuur bericht: ${message}`,
		ariaLabelButtonCloseImageViewer: "sluit afbeelding weergave",
